...
plot_ml <- function(data, comp, index, algo, pdf = F, taxo_group) {
  
  #combi1 <- inf_$indices[,"NSI"]
  #combi2 <- COMP[,"NSI"]
  #index <- "NSI"
  #algo <- "Inference assigned metazoan - V9"
  
  combi1 <- data
  combi2 <- comp[,index]
  ## agregate results by grab
  # predictions
  ...
  if (index == "AMBI") 
  {
    ...
    plot(combined1 ~ combined2, xlim=c(0,6), ylim=c(0,6), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("AMBI prediction /", algo), xlab = "Morphology", ylab = "Molecular")
  ...
  if (index == "microAMBI") 
  {
    ...
    #col2 <- col[as.integer(as.factor(farm_nam))]
    #col <-  comp_foram$Col_plot
    plot(combined1 ~ combined2, xlim=c(0,6), ylim=c(0,6), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("microAMBI prediction /", algo), xlab = "Morphology", ylab = "Molecular")
  ...
  if (index == "NSI") 
  {
    ...
    plot(combined1 ~ combined2, xlim=c(0,31), ylim=c(0,31), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("NSI prediction /", algo), xlab = "Morphology", ylab = "Molecular")
    arrows(combined2, combined1-combined1_sd, combined2, combined1+combined1_sd, length=0.01, angle=90, code=3, col=col)
    abline(mod, col="blue")
  ...
  if (index == "NQI1") 
  {
    ...
    plot(combined1 ~ combined2, xlim=c(0,1), ylim=c(0,1), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("NQI1 prediction /", algo), xlab = "Morphology", ylab = "Molecular")
    arrows(combined2, combined1-combined1_sd, combined2, combined1+combined1_sd, length=0.01, angle=90, code=3, col=col)
    abline(mod, col="blue")
  ...
  if (index == "ISI") 
  {
    ...
    plot(combined1 ~ combined2, xlim=c(0,13), ylim=c(0,13), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("ISI prediction /", algo), xlab = "Morphology", ylab = "Molecular")
    arrows(combined2, combined1-combined1_sd, combined2, combined1+combined1_sd, length=0.01, angle=90, code=3, col=col)
    abline(mod, col="blue")
  ...
  if (index == "Shannon") 
  {
    ...
    plot(combined1 ~ combined2, xlim=c(0,5.7), ylim=c(0,5.7), pch =col, col= col,  xaxs="i",yaxs="i",cex=1, main = paste("Shannon prediction /", algo), xlab = "Morphology", ylab = "Molecular")
    arrows(combined2, combined1-combined1_sd, combined2, combined1+combined1_sd, length=0.01, angle=90, code=3, col=col)
    abline(mod, col="blue")
